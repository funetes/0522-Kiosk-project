...
public sealed class CafeKioskPasswordPopup
{
    ...
    private void Build(Transform parent, Color paper, Color charcoal, Color espresso, System.Action onAction, System.Action onSuccess)
    {
        ...
        var title = CafeKioskUIUtility.Label("������ ����", modal, 24, charcoal, FontStyle.Bold, TextAnchor.MiddleCenter, font);
        CafeKioskUIUtility.Anchor(title.rectTransform, 0f, 0.75f, 1f, 0.95f, 0f, 0f, 0f, 0f);

        messageText = CafeKioskUIUtility.Label("���� 4�ڸ��� �Է��ϼ���", modal, 14, new Color(0.5f, 0.5f, 0.5f), FontStyle.Normal, TextAnchor.MiddleCenter, font);
        ...
        var confirmBtn = CafeKioskUIUtility.Button("Ȯ��", modal, 18, espresso, Color.white, () => {
            ...
            else
            {
                ...
                messageText.text = "���� 4�ڸ��� �Է����ּ���!";
                passwordInput.text = "";
            }
        }, font, 100f, 40f);
        CafeKioskUIUtility.Anchor(confirmBtn.GetComponent<RectTransform>(), 0.55f, 0.15f, 0.85f, 0.3f, 0f, 0f, 0f, 0f);

        var cancelBtn = CafeKioskUIUtility.Button("���", modal, 18, new Color(0.4f, 0.4f, 0.4f), Color.white, () => {
            Hide();
            onAction?.Invoke();
        }, font, 100f, 40f);
    ...
    public void Show() { Root.gameObject.SetActive(true); passwordInput.text = ""; messageText.text = "���� 4�ڸ��� �Է��ϼ���"; }
